...
// extract the real server error message (e.g. "Product not found")
...
export const newReview = (reviewData) => async (dispatch) => {
  try {
    ...
    dispatch({ type: NEW_REVIEW_FAIL, payload: serverError(error) });
  }
};
...
export const getAdminProducts = () => async (dispatch) => {
  try {
    ...
    dispatch({ type: ADMIN_PRODUCT_FAIL, payload: serverError(error) });
  }
};
...
export function deleteProduct(id) {
  return async function (dispatch) {
    try {
      ...
      dispatch({ type: DELETE_PRODUCT_FAIL, payload: serverError(error) });
    }
  };
}
...
export const getAllreviews = (productId) => async (dispatch) => {
  try {
    ...
    dispatch({ type: ALL_REVIEW_FAIL, payload: serverError(error) });
  }
};
...
export const deleteProductReview = (reviewId, productId) => async (dispatch) => {
  try {
    ...
    dispatch({ type: DELETE_REVIEW_FAIL, payload: serverError(error) });
  }
};
