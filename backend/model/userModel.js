...
userSchema.methods.comparePassword = async function (password) {
  return await bcrypt.compare(password, this.password); // this function will check when user login with plain password and bcrypt.compare will check that password with hashed password in DataBase.
};
